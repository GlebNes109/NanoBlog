...
@pytest.mark.asyncio
async def test_add_to_favorites_already_exists(mock_favorite_repository, sample_user_id, sample_post_id):
    """Test adding already favorited post."""
    service = FavoritesService(mock_favorite_repository)
...
@pytest.mark.asyncio
async def test_remove_from_favorites_success(mock_favorite_repository, sample_user_id, sample_post_id):
...
@pytest.mark.asyncio
async def test_remove_from_favorites_not_found(mock_favorite_repository, sample_user_id, sample_post_id):
