...
async def test_rate_post_positive(mock_rating_repository, sample_user_id, sample_post_id):
    """Test rating a post with positive rating."""
...
async def test_rate_post_negative(mock_rating_repository, sample_user_id, sample_post_id):
    """Test rating a post with negative rating."""
    service = RatingsService(mock_rating_repository)
...
@pytest.mark.asyncio
async def test_rate_post_invalid_negative_value(mock_rating_repository, sample_user_id, sample_post_id):
    """Test rating with invalid negative value."""
    service = RatingsService(mock_rating_repository)
