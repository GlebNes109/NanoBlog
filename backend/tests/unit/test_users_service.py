...
@pytest.mark.asyncio
async def test_create_user_duplicate_email(mock_user_repository, mock_password_hasher, sample_user_read):
...
@pytest.mark.asyncio
async def test_create_user_duplicate_login(mock_user_repository, mock_password_hasher, sample_user_read):
...
@pytest.mark.asyncio
async def test_get_user_success(mock_user_repository, mock_password_hasher, sample_user_public, sample_user_id):
...
@pytest.mark.asyncio
async def test_delete_user_different_user(mock_user_repository, mock_password_hasher, sample_user_id):
    """Test user deletion by different user."""
    service = UsersService(mock_user_repository, mock_password_hasher)
