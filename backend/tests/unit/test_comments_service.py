...
@pytest.mark.asyncio
async def test_create_comment_empty_content(mock_comment_repository, sample_post_id, sample_user_id):
...
@pytest.mark.asyncio
async def test_create_comment_whitespace_only(mock_comment_repository, sample_post_id, sample_user_id):
...
async def test_delete_comment_success(
    mock_comment_repository, sample_comment_read, sample_user_id
):
